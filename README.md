...
- upload the [```sample_data```](https://github.com/Goodboy0416/FamilyTreeAPI/tree/main/sample_data) of electorals in json format in your mongoDB [electoral collection](https://github.com/jhonsnow456/FamilyTreeAPI/blob/main/sample_data/electoral_data.json). 
- upload the [```sample_data```](https://github.com/Goodboy0416/FamilyTreeAPI/tree/main/sample_data) of places in json format in your mongoDB [places collection](https://github.com/jhonsnow456/FamilyTreeAPI/blob/main/sample_data/places_data.json).
